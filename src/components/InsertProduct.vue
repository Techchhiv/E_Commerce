<template>
    <div class="flex justify-center items-center w-full h-screen">
        <div class="flex-col flex items-center bg-gray-100 p-10 rounded-xl justify-center">
            <p class="font-Playfair font-bold mb-10 text-[32px]">Insert Data</p>
            <form @submit.prevent="insertProduct" action="" class="flex-col gap-4 ">
    ...
    export default{
        ...
        methods:{
            ...
            async insertProduct(){
                ...
                .catch((err)=>{
                    console.log('Insert product:',err);
                });
            },
